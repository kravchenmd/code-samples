...
ME_URL = reverse('user:me')  # details of current authenticated user
...
class PublicUserApiTest(TestCase):
    ...
    def test_create_user_success(self):
        ...
        # check if password is not returning accidently
...
class PrivateUserApiTest(TestCase):
    """Tets API requests that require authentication."""
