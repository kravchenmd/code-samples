...
from .modules import address_book as f
from .modules import shared_functions
...
from .notebook import notes_class as n
...
class ConsoleInterface(UserInterface):
    ...
    def handle_request(self):
        ...
        while True:
            ...
            print(result)
            if func == shared_functions.exit_program or func == n.exit_notes:
                sys.exit()
